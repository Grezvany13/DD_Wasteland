...
//Rifle_man
_man11 = _group createunit ["Woodlander4", [_pos select 0, (_pos select 1) + 60, 0], [], 0.5, "Form"];
...
//Rifle_man
_man12 = _group createunit ["Woodlander4", [_pos select 0, (_pos select 1) - 60, 0], [], 0.5, "Form"];
...
//Rifle_man
_man13 = _group createunit ["Woodlander4", [_pos select 0, (_pos select 1) + 70, 0], [], 0.5, "Form"];
...
//Rifle_man
_man14 = _group createunit ["Woodlander4", [_pos select 0, (_pos select 1) - 70, 0], [], 0.5, "Form"];
...
//Rifle_man
_man15 = _group createunit ["Woodlander4", [_pos select 0, (_pos select 1) + 30, 0], [], 0.5, "Form"];
...
//Rifle_man
_man16 = _group createunit ["Woodlander4", [_pos select 0, (_pos select 1) + 30, 0], [], 0.5, "Form"];
