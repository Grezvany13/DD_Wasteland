...
//Rifleman
_leader = _group createUnit ["GER_Soldier_TL_EP1", [(_pos select 0) - 10, (_pos select 1) + 10, 15.5], [], 0.5,"FORM"];
...
//Anti Vehicle
_man2 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 9, (_pos select 1) + 10, 15.5], [], 0.5, "FORM"];
...
//Anti Vehicle
_man3 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 8, (_pos select 1) + 10, 15.5], [], 0.5, "FORM"];
...
//Support
_man4 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 7, (_pos select 1) + 10, 15.5], [], 0.5, "FORM"];
_man4 addMagazine "100Rnd_762x51_M240";
_man4 addMagazine "100Rnd_762x51_M240";
_man4 addWeapon "Mk_48_DES_EP1";

//Support
_man5 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 6, (_pos select 1) + 10, 15.5], [], 0.5, "FORM"];
_man5 addMagazine "100Rnd_762x51_M240";
_man5 addMagazine "100Rnd_762x51_M240";
_man5 addWeapon "Mk_48_DES_EP1";

//Sniper
_man6 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 5, (_pos select 1) + 10, 15.5], [], 0.5, "FORM"];
_man6 addMagazine "5Rnd_762x51_M24";
_man6 addMagazine "5Rnd_762x51_M24";
_man6 addMagazine "5Rnd_762x51_M24";
_man6 addMagazine "5Rnd_762x51_M24";
...
//Rifleman
_man7 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 4, (_pos select 1) + 10, 15.5], [], 0.5, "FORM"];
...
//Rifleman
_man8 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 3, (_pos select 1) + 10, 15.5], [], 0.5, "FORM"];
...
//Rifleman
_man9 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 2, (_pos select 1) + 10, 15.5], [], 0.5, "FORM"];
...
//Rifleman
_man11 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 10, (_pos select 1) + 9, 15.5], [], 0.5, "FORM"];
...
//Rifleman
_man12 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 10, (_pos select 1) + 7, 15.5], [], 0.5, "FORM"];
...
//Sniper
_man13 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 10, (_pos select 1) + 6, 15.5], [], 0.5, "FORM"];
...
//Support
_man14 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 10, (_pos select 1) + 5, 15.5], [], 0.5, "FORM"];
_man14 addMagazine "100Rnd_762x51_M240";
_man14 addMagazine "100Rnd_762x51_M240";
_man14 addWeapon "Mk_48_DES_EP1";

//Leader
_man15 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 10, (_pos select 1) + 8, 15.5], [], 0.5, "FORM"];
