...
//Leader
_leader = _group createUnit ["GER_Soldier_TL_EP1", [_pos select 0, (_pos select 1) - 6, 0], [], 0, "FORM"];
...
//Rifleman
_man2 = _group createUnit ["GER_Soldier_EP1", [_pos select 0, (_pos select 1) - 7, 0], [], 0, "FORM"];
...
//Rifleman
_man3 = _group createUnit ["GER_Soldier_EP1", [_pos select 0, (_pos select 1) - 8, 0], [], 0, "FORM"];
...
//Sniper
_man4 = _group createUnit ["GER_Soldier_EP1", [_pos select 0, (_pos select 1) - 9, 0], [], 0, "FORM"];
...
//Support
_man5 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) + 1, (_pos select 1) - 1, 0], [], 0, "FORM"];
