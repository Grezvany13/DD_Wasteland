...
//Leader
_leader = _group createUnit ["GER_Soldier_TL_EP1", [(_pos select 0) - 10, (_pos select 1) + 8, 15.5], [], 0.5, "FORM"];
...
//Rifleman
_man2 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 10, (_pos select 1) + 7, 15.5], [], 0.5, "FORM"];
...
//Sniper
_man3 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 10, (_pos select 1) + 6, 15.5], [], 0.5, "FORM"];
...
//Support
_man4 = _group createUnit ["GER_Soldier_EP1", [(_pos select 0) - 10, (_pos select 1) + 5, 15.5], [], 0.5, "FORM"];
